...
public class ModeloTabelaJogos extends AbstractTableModel {
   ...
   private final String[] colunas = {"Placar","Data","Horario","Casa","Visitante","ID"};
    ...
    private boolean[] columnsCanEdit = {false,true, true,false,false,false};

    public boolean[] getColumnsCanEdit() {
        return columnsCanEdit;
    }

    public void setColumnsCanEdit(boolean[] columnsCanEdit) {
        this.columnsCanEdit = columnsCanEdit;
    }
    
    public ModeloTabelaJogos() {
    }
    
    @Override
    public int getRowCount() {
        return Jogo.getJogos().size();
    }
     @Override
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        jogo = Jogo.getJogos().get(rowIndex);
